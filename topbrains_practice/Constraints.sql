...
ALTER TABLE INSTRUCTOR_INFO ADD CONSTRAINT INSTRUCTOR_FK FOREIGN KEY (ZIP_CODE) REFERENCES ZIPCODE_INFO(ZIP_CODE);
...
ALTER TABLE COURSE_INFO ALTER COLUMN COST NUMERIC(5,2) NOT NULL;

--STUDENT_INFO TABLE
ALTER TABLE STUDENT_INFO ADD CONSTRAINT STUDENT_ID_PK PRIMARY KEY (STUDENT_ID);
ALTER TABLE STUDENT_INFO ADD CONSTRAINT STUDENT_FN_NN CHECK (STUDENT_FIRST_NAME IS NOT NULL);
...
ALTER TABLE STUDENT_INFO ADD CONSTRAINT STUDENT_LN_NN CHECK (STUDENT_LAST_NAME IS NOT NULL);
...
ALTER TABLE GRADE_INFO ADD CONSTRAINT DF_NUMERIC_GRADE DEFAULT 0 FOR NUMERIC_GRADE;
